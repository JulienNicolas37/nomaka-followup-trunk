                            ...
                            <li id="${task.taskId}list-task" class="list-line ${task.taskClassListLine}">
                                ...
                                <div class="block-bottom">
                                    ...
                                    <#if task.taskStatus == "Ready">
                                        <a id="${task.taskId}startButton" style="display:block" href="#" onClick="sendStart('<@ofbizUrl>startProductionTask</@ofbizUrl>','${task.fabOrderId}', '${task.taskId}', '${task.taskOriginalStatus}');" class="btn-start"><span class="txt-btn">${uiLabelMap.FollowupTaskStart}</span></a>
                                        <a id="${task.taskId}resumeButton" style="display:none" href="#" onClick="sendResume('<@ofbizUrl>resumeProductionTask</@ofbizUrl>','${task.taskId}');" class="btn-start"><span class="txt-btn">${uiLabelMap.FollowupTaskResume}</span></a>
                                        ...
                                        <a id="${task.taskId}stopButton" style="display:none" href="#" onClick="sendStop('<@ofbizUrl>stopProductionTask</@ofbizUrl>','${task.fabOrderId}', '${task.taskId}', '${task.taskOriginalStatus}');" class="btn-stop"><span class="txt-btn">${uiLabelMap.FollowupTaskEnd}</span></a>
                                    <#else>
                                    <#if task.taskStatus == "Break">
                                        <a id="${task.taskId}startButton" style="display:none" href="#" onClick="sendStart('<@ofbizUrl>startProductionTask</@ofbizUrl>','${task.fabOrderId}', '${task.taskId}', '${task.taskOriginalStatus}');" class="btn-start"><span class="txt-btn">${uiLabelMap.FollowupTaskStart}</span></a>
                                        <a id="${task.taskId}resumeButton" style="display:block" href="#" onClick="sendResume('<@ofbizUrl>resumeProductionTask</@ofbizUrl>','${task.taskId}');" class="btn-start"><span class="txt-btn">${uiLabelMap.FollowupTaskResume}</span></a>
                                        <a id="${task.taskId}pauseButton" style="display:none" href="#" onClick="sendPause('<@ofbizUrl>pauseProductionTask</@ofbizUrl>','${task.taskId}');" class="btn-pause"><span class="txt-btn">${uiLabelMap.FollowupTaskBreak}</span></a>
                                        <a id="${task.taskId}stopButton" style="display:block" href="#" onClick="sendStop('<@ofbizUrl>stopProductionTask</@ofbizUrl>','${task.fabOrderId}', '${task.taskId}', '${task.taskOriginalStatus}');" class="btn-stop"><span class="txt-btn">${uiLabelMap.FollowupTaskEnd}</span></a>
                                    <#else>
